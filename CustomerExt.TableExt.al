tableextension 50147 CustomerExt extends Customer
{
    fields
    {
        ...
        field(51520000; PML; Boolean)
        {
        }
        field(51520001; "CustomerType";Enum CustomerType)
        {
            Caption = 'Customer Type';
        }
        field(51520002; "Date of Incorporation"; date)
        {
            Caption = 'Date of Incorporation';
        }
        field(51520005; "Created By"; Code[50])
        {
        }
        field(51520006; "Date-Time Created"; DateTime)
        {
        }
        field(51520007; "Shareholding Value"; Decimal)
        {
        }
        field(51520009; "Payroll Loan No. Filter"; Code[50])
        {
            TableRelation = "Loan Application" where("Debtors Code"=field("No."));
            FieldClass = FlowFilter;
        }
        field(51520010; "Loan Transaction Type Filter";enum LoanTransactionTypes)
        {
            FieldClass = FlowFilter;
        }
        field(51520011; "PML Abbreviation"; Code[10])
        {
        }
        field(51520012; "Company Pin No."; Code[100])
        {
        ...
        field(51520013; "Company Registration No."; Code[100])
        {
        ...
        field(51520014; "ID Number"; Code[20])
        {
            DataClassification = ToBeClassified;
        ...
        field(51520015; "Individual Pin Number"; Code[20])
        {
            DataClassification = ToBeClassified;
        ...
        field(51520016; "Imprest Posting Group"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Customer Posting Group";
        }
        field(51520017; "Petty Cash Posting Group"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Customer Posting Group";
        }
        field(51520018; "Applicant No"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(51520019; "Cust. Trans. Type Filter";enum "Customer Transaction Types")
        {
            FieldClass = FlowFilter;
        }
        field(51520020; "Balance Due(LCY2)"; Decimal)
        {
        ...
        field(51520021; "Balance (LCY)2"; Decimal)
        {
            FieldClass = FlowField;
            AutoFormatType = 1;
