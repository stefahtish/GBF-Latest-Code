tableextension 50155 GL_AccountExt extends "G/L Account"
{
    fields
    {
        ...
        field(500024; "Current Budget"; Code[20])
        {
        }
    ...
    var CreateGL: Label 'Do you want to create this G/L Account in %1 Company?';
    ...
    begin
        ...
        if CompanyRec.Find('-')then begin
            repeat GLAccount2.ChangeCompany(CompanyRec.Name);
