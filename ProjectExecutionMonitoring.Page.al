page 51350 ProjectExecutionMonitoring
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    actions
    {
        area(processing)
        {
            ...
            action(Print)
            {
                Caption = 'Project Execution & Monitoring Report';
                Image = Report;
                Promoted = true;
                ...
                begin
                    ...
                    REPORT.Run(Report::"Project Monitoring,Evaluation", true, true, ProjectIdentification);
                end;
            }
            action(Approve)
            {
