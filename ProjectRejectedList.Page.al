page 51379 ProjectRejectedList
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    Sourcetableview = where("Project approval status"=filter(Rejected|cancelled), "project status"=filter(open));
    RefreshOnActivate = true;
    Caption = 'Project Rejected List';
