tableextension 50132 PurchRcptLineExt extends "Purch. Rcpt. Line"
{
    fields
    {
        ...
        field(50042; "General Expense Code"; Code[20])
        {
            DataClassification = ToBeClassified;
        ...
        field(54033; Amount; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(54034; "Amount Including VAT"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
