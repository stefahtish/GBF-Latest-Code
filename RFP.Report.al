report 50314 RFP
{
    ...
    dataset
    {
        dataitem("Supplier Selection"; "RFP Supplier Selection")
        {
    ...
    var
        CompNameCaption: Label 'NATIONAL IRRIGAION BOARD';
        ReportTitleCaption: Label 'REQUEST FOR QOUTATION';
        Inivite: Label 'You are invited to submit Proposal on materials listed below:';
        NoteA: Label '(a) THIS IS NOT AN ORDER. Read the conditions and instructions on reverse before quoting.';
        NoteC: Label '(c) Your Proposal should indicate final unit price which includes all costs for delivery ,discount, duty and sales tax.';
        ...
        NBCaption: Label 'N/B: Please attach your AGPO certificate ( if registered) when submitting your Proposal';
        ...
        Instruct4: Label '4.Each Proposal should be submitted separately in a sealed envelope with the Proposal Number endorsed on the outside.Descriptive literature or samples of the items offered may be forwarded with the quotation.';
