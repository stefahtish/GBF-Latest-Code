report 50306 RFQ
{
    ...
    var
        CompNameCaption: Label 'KENYA INSTITUTE FOR PUBLIC POLICIES RESEARCH AND ANALYSIS';
        ...
        NoteC: Label '(c) Your quotation should include all costs for  delivery of goods including duty, tax, delivery charges  and placed in the Tender box at NSSF.';
