report 50223 "2 Page Payslip"
{
    // ArrEarnings[1,1]
    // ArrEarningsAmt[1,1]
    DefaultLayout = RDLC;
    RDLCLayout = './2PagePayslip.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            begin
                //Pick Logo
                if Employee.Company <> '' then CompanyInfo.ChangeCompany(Employee.Company);
                CompanyInfo.Get;
            ...
            */
               ...
               */
                ...
                */
                ...
                i := i + 1;
                if EmpBank.Get(Employee."Employee's Bank") then BankName := EmpBank.Name;
                ArrEarnings[1, i] := 'Employee Bank';
                ArrEarningsAmt[1, i] := BankName;
                i := i + 1;
                ArrEarnings[1, i] := 'Bank Branch';
                if EmpBankBranch.Get(Employee."Employee's Bank", Employee."Bank Branch") then ArrEarningsAmt[1, i] := EmpBankBranch."Branch Name";
                i := i + 1;
    ...
    var
        ...
        GetPaye: Codeunit "Payroll Management";
        PayeeTest: Decimal;
