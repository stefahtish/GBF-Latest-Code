page 50774 "Ammend Purchase Orders"
{
    Caption = 'Ammend Purchase Orders';
    PageType = Document;
    ...
    SourceTableView = WHERE("Document Type" = FILTER(Order), "OrderType" = filter(Ammend));
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Ammend Order No"; Rec."Ammend Order No")
                {
                    ApplicationArea = All;
                }
            }
                ...
                group(Control71)
                {
                    ...
                    group(Control95)
                    {
                        ...
                        field("Pay-to Name"; Rec."Pay-to Name")
                        {
                            ...
                            trigger OnValidate()
                            begin
                                if Rec.GetFilter("Pay-to Vendor No.") = xRec."Pay-to Vendor No." then if Rec."Pay-to Vendor No." <> xRec."Pay-to Vendor No." then Rec.SetRange("Pay-to Vendor No.");
                                CurrPage.Update;
                            end;
                        }
        ...
        area(navigation)
        {
            group("O&rder")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        // eddie WorkflowsEntriesBuffer.RunWorkflowEntriesPage(
    ...
    begin
        ...
        Rec."OrderType" := Rec."OrderType"::Ammend;
