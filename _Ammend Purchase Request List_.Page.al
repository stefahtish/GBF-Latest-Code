page 51318 "Ammend Purchase Request List"
{
    CardPageID = "Ammend Purchase Request";
    DeleteAllowed = false;
    PageType = List;
    SourceTable = "Internal Request Header";
    SourceTableView = WHERE("Document Type" = CONST(Purchase), "Fully Ordered" = CONST(false), Status = FILTER(Open | "Pending Approval"), "Requisition Type" = const(Ammend));
    ApplicationArea = All;
