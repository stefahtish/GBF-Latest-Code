page 50595 "Appraisal List UnderReview Q1"
{
    ...
    SourceTableView = WHERE(Status = FILTER("Mid-Year Approved" | "Pending Approval" | Released), "Appraisal Status" = FILTER(Review | Set), AppraisalType = CONST(Q1));
    ApplicationArea = All;
