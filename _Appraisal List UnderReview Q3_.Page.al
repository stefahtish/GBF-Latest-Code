page 50597 "Appraisal List UnderReview Q3"
{
    ...
    SourceTableView = WHERE(Status = FILTER("Mid-Year Approved" | "Pending Approval" | Released), "Appraisal Status" = FILTER(Review | Set), AppraisalType = CONST("Q3"));
    ApplicationArea = All;
