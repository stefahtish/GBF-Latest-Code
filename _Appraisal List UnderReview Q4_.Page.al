page 50598 "Appraisal List UnderReview Q4"
{
    ...
    SourceTableView = WHERE(Status = FILTER("Mid-Year Approved" | "Pending Approval" | Released), "Appraisal Status" = FILTER(Review | Set), AppraisalType = CONST("Q4"));
    ApplicationArea = All;
