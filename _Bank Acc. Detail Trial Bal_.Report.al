report 50470 "Bank Acc. Detail Trial Bal"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BankAccDetailTrialBal.rdl';
        ...
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
            {
                ...
                begin
                    ...
                    BankAccBalanceLCY:=BankAccBalanceLCY + "Amount (LCY)" end;
            ...
            begin
                StartBalance:=0;
                if DateFilter_BankAccount <> '' then if GetRangeMin("Date Filter") <> 0D then begin
                ...
                //detailed CurrReport.PrintOnlyIfDetail := ExcludeBalanceOnly or (StartBalance = 0);
    ...
    PageGroupNo: Integer;
    BankAccDetailTrialBalCapLbl: Label 'Cash Book Balance';
