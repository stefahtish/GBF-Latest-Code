report 50456 "Bank Employee Payments"
{
    UsageCategory = Administration;
    DefaultLayout = RDLC;
    RDLCLayout = 'BankEmployeePayments.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            column(Employee_Bank_Branch; BankBranch)
            {
            }
            column(BankAccountNumber_Employee; "Bank Account Number")
            {
            }
            column(EmployeesBank_Employee; "Employee's Bank")
            {
            }
            column(EmployeeBankName_Employee; "Employee Bank Name")
            {
            }
            column(Employee_AccNo; EmployeeAcc)
            {
            }
            column(Net_Pay; NewnetPay)
            {
            }
            column(Amount_Sum; AmountSum)
            {
            }
            ...
            column(Approver; GetUserName(Approver[3]))
            {
            }
            column(Date_Approved; ApproverDate[3])
            {
            }
            ...
            begin
                ...
                // if EmpBank."Cheque Payments" then
                //     CurrReport.Skip();
