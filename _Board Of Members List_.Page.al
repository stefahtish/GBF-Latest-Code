page 50711 "Board Of Members List"
{
    Caption = 'Board of members List';
    CardPageID = "Board of Members Card";
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Report,New Document,BoardMember,Navigate';
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action(ApplyTemplate)
            {
                ...
                begin
                    CurrPage.SetSelectionFilter(Vendor);
                    MiniVendorTemplate.CopyFromTemplate(MiniVendorTemplate)
                end;
            }
            action(PayVendor)
            {
