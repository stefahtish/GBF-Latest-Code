page 50710 "Board of Members Card"
{
    Caption = 'Board of Members Card';
    PageType = Card;
                ...
                field("Block Payment Tolerance"; Rec."Block Payment Tolerance")
                {
                    ...
                    begin
                        if Rec."Block Payment Tolerance" then begin
                            if ConfirmManagement.GetResponseOrDefault(Text002, true) then PaymentToleranceMgt.DelTolVendLedgEntry(Rec);
                        end
                        else begin
                            if ConfirmManagement.GetResponseOrDefault(Text001, true) then PaymentToleranceMgt.CalcTolVendLedgEntry(Rec);
                        end;
                    end;
                }
        ...
        area(processing)
        {
            ...
            group("F&unctions")
            {
                ...
                action(ApplyTemplate)
                {
                    ...
                    begin
                        //eddie 
                        MiniVendorTemplate.CopyFromTemplate(MiniVendorTemplate); //(Rec);
                    end;
                }
                action(SaveAsTemplate)
                {
                    ...
                    trigger OnAction()
                    var
                        TempMiniVendorTemplate: Record "Vendor Templ." temporary;
                    begin
                        //eddie TempMiniVendorTemplate.SaveAsTemplate(Rec);
                    end;
                }
    ...
    begin
        ...
        if Rec."No." <> '' then CurrPage.AgedAccPayableChart.PAGE.UpdateChartForVendor(Rec."No.");
    ...
    begin
        ...
        else if VendorTemplMgt.TemplatesAreNotEmpty() then CurrPage.Close;
    end;
