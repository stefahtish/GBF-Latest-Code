page 51356 "Contracts Extended"
{
    CardPageID = "Extended Contract";
    Caption = 'Contracts Extended';
    Editable = false;
    PageType = List;
    InsertAllowed = false;
    SourceTable = "Project Header";
    SourceTableView = WHERE("Extension Status" = CONST("Approved"), "Direct Contract" = const(false));
    ApplicationArea = All;
