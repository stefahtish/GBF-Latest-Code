page 51358 "Contracts Terminated"
{
    CardPageID = "Terminated Contract";
    Caption = 'Contracts Terminated List';
    Editable = false;
    PageType = List;
    InsertAllowed = false;
    SourceTable = "Project Header";
    SourceTableView = WHERE(Stage = const(Termination), "Direct Contract" = const(false));
    ApplicationArea = All;
