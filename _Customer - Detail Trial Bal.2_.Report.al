report 50146 "Customer - Detail Trial Bal.2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerDetailTrialBal-cust.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            begin
                ...
                //eddie  CurrReport.PrintOnlyIfDetail := ExcludeBalanceOnly or (StartBalanceLCY = 0);
