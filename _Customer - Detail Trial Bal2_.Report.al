report 50168 "Customer - Detail Trial Bal2"
{
    DefaultLayout = RDLC;
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    CustDebitAmount:=0;
                    CustCreditAmount:=0;
                    if CustAmount > 0 then CustDebitAmount:=CustAmount
                    else
            ...
            begin
                ...
                //eddie repor CurrReport.PrintOnlyIfDetail := ExcludeBalanceOnly or (StartBalanceLCY = 0);
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(StartDate; StartDate)
                    {
                        ...
                        ToolTip = 'Specifies the period Start date for the report filter';
                    }
                    field(EndDate; EndDate)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'End date';
                        ToolTip = 'Specifies the period End date for the report filter';
                    }
    ...
    ERR_EndDate: Label 'Perio End date must have a value';
