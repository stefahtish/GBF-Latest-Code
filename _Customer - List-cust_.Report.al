report 50147 "Customer - List-cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerList-cust.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(Customer__Credit_Limit__LCY__Caption; CreditAmountLCYCaption)
            {
            }
            column(Customer__Balance__LCY__Caption; BalanceLCYCaption)
            {
            }
            ...
            begin
                ...
                FormatAddr.FormatAddr(CustAddr, Name, "Name 2", '', Address, "Address 2", City, "Post Code", County, "Country/Region Code");
            end;
        }
    }
    requestpage
    ...
    var
        ...
        CreditAmountLCYCaption: Label 'Credit Limit (KES)';
