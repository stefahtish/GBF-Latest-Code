report 50153 "Customer - Trial Balance-Cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerTrialBalance-Cust.rdlc';
    ...
    var
        ...
        AmtsinLCYCaptionLbl: Label 'Amounts in KES';
        ...
        TotalinLCYCaptionLbl: Label 'Total in KES';
