report 50144 "Customer Register-Cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerRegister-cust.rdlc';
    ...
    dataset
    {
        dataitem("G/L Register"; "G/L Register")
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                begin
                    if not Cust.Get("Customer No.") then Cust.Init();
                    ...
                    if ("Document Type" = "Document Type"::Payment) or ("Document Type" = "Document Type"::Refund) then "Due Date" := 0D;
                end;
    ...
    var
        ...
        CustDebitAmountLCYCaptionLbl: Label 'Debit (KES)';
        CustCreditAmountLCYCaptionLbl: Label 'Credit (KES)';
        CustAmountLCYCaptionLbl: Label 'Total (KES)';
        CustDebitAmountLCY_Control65CaptionLbl: Label 'Debit (KES)';
        CustCreditAmountLCY_Control68CaptionLbl: Label 'Credit (KES)';
        CustAmountLCY_Control71CaptionLbl: Label 'Total (KES)';
