report 50149 "Customer/Item Sales-cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerItemSales-cust.rdlc';
        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Value Entry"; "Value Entry")
            {
                ...
                begin
                    ...
                    if not EntryInBufferExists then ValueEntryBuffer."Entry No." := "Item Ledger Entry No.";
    ...
    begin
        if Customer.IsEmpty() and GuiAllowed() then Error(EmptyReportDatasetTxt);
    end;
