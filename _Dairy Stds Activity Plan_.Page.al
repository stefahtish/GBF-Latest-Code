page 51049 "Dairy Stds Activity Plan"
{
    Caption = 'Dairy Standard';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            {
                ApplicationArea = Basic, Suite;
                SubPageLink = "Document No." = FIELD(Code), Activity = const(Dairy);
            }
        }
    }
    actions
    {
        area(Processing)
        {
            ...
            action("Dairy Standards Activity Plan")
            {
                ...
                begin
                    ...
                    REPORT.RUN(Report::"Dairy Activity", TRUE, FALSE, Workplan);
                end;
            }
        }
    }
    ...
    begin
        Rec."Research type" := Rec."Research type"::Dairystds;
    end;
