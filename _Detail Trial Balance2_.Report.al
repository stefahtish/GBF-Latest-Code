report 50471 "Detail Trial Balance2"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                trigger OnAfterGetRecord()
                begin
                //eddie detailed CurrReport.PrintOnlyIfDetail := ExcludeBalanceOnly or (StartBalance = 0);
                end;
            }
            trigger OnAfterGetRecord()
            var
            ...
            begin
                ...
                if PrintOnlyOnePerPage then begin
                    ...
                    //eddie  if CurrReport.PrintOnlyIfDetail and GLEntry.FindFirst then
    ...
    DetailTrialBalCaptionLbl: Label 'General Ledger Balance';
    ...
    protected var NumberOfGLEntryLines: Integer;
