report 50484 "Evaluation Committee Report"
{
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './EvalCommitteReport.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Tender Committees"; "Tender Committees")
        {
            ...
            column(ReportTitle; 'APPOINTMENT TO QUOTATION EVALUATION COMMITTEE')
            {
            }
            ...
            begin
                ...
                Clear(ApprovalName);
                Clear(ApprovalTitle);
                Paragraph1 := 'Pursuant to section 46 and section 80 of the Public Procurement & Asset Disposal Act (2015), you have been appointed as a member to the quotation evaluation committee for the following quotation(s):';
