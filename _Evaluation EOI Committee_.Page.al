page 50345 "Evaluation EOI Committee"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(EOI), "Committee Type" = const(Evaluation));
    CardPageId = "Evaluation EOI Commitee Card";
    ApplicationArea = All;
