page 50339 "Evaluation RFP Committee"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(RFP), "Committee Type" = const(Evaluation));
    CardPageId = "Evaluation RFP Commitee Card";
    ApplicationArea = All;
