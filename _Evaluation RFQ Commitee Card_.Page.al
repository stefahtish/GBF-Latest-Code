page 50334 "Evaluation RFQ Commitee Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part("Committee Members"; "Eval Committee Members")
            {
                Editable = DocEditable;
                SubPageLink = "Appointment No" = field("Appointment No");
            }
            field("Evaluation Comment"; Rec."Evaluation Comment")
            {
            }
        }
    }
    actions
    {
        ...
        area(Reporting)
        {
            ...
            action("Eval Commitee Scores")
            {
                ...
                trigger OnAction()
                var
                    CommRept: Report "Evaluation Committee Report";
                begin
                    Clear(CommRept);
                    CommiteeRec.Reset();
                    CommiteeRec.SetFilter("Appointment No", Rec."Appointment No");
    ...
    begin
        ...
        Rec."Committee Type" := Rec."Committee Type"::Evaluation;
    end;
