page 50333 "Evaluation RFQ Committee"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(Quotation), "Committee Type" = const(Evaluation));
    CardPageId = "Evaluation RFQ Commitee Card";
    ApplicationArea = All;
