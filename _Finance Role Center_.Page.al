page 50224 "Finance Role Center"
{
    PageType = RoleCenter;
    ApplicationArea = All;
        ...
        area(sections)
        {
                ...
                group("Group7")
                {
                    ...
                    group("Group8")
                    {
                        ...
                        action("Detail Trial Balance")
                        {
                            ...
                            RunObject = report "Detail Trial Balance2";
                        }
            ...
            group("Group28")
            {
                ...
                group("Group34")
                {
                    ...
                    // action("Sales per Branch")
                    // {
                    //     ApplicationArea = Basic, Suite;
                    //     RunObject = report "Branch Sales";
                    // }
            ...
            group("Group55")
            {
                ...
                group(Setups)
                {
                    ...
                    action("Imprest Surrender Docs")
                    {
                        ApplicationArea = Basic, Suite;
                        RunObject = page "Surrender Docs Setup";
                    }
