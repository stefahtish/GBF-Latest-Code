report 50213 "Gross Earnings & Deductions"
{
    DefaultLayout = RDLC;
    RDLCLayout = './GrossEarnings.rdl';
    ApplicationArea = All;
        ...
        dataitem("Payroll PeriodX"; "Payroll PeriodX")
        {
            ...
            dataitem(EarningsX; EarningsX)
            {
                ...
                dataitem("Assignment Matrix-X"; "Assignment Matrix-X")
                {
                    ...
                    DataItemTableView = SORTING(Type, Code, "Payroll Period", "Reference No") WHERE(Type = CONST(Payment), "Employee type" = filter(<> trustee));
                    ...
                    begin
                        if AssignM.Get("Assignment Matrix-X".Code) then begin
            ...
            dataitem(DeductionsX; DeductionsX)
            {
                ...
                dataitem("Assignment Matrix-XD"; "Assignment Matrix-X")
                {
                    ...
                    column(Assignment_Matrix_XD__Assignment_Matrix_X__Amount; Amount)
                    {
                    }
            ...
            begin
                ...
                //   ApprovalEntries.SetRange("Table ID", Database::payroll);
    ...
    procedure SetDefaults(PayAppCode: Code[50]; Amt: Decimal)
    begin
        PayApprovalCode := PayAppCode;
        BankCharges := Amt;
    end;
