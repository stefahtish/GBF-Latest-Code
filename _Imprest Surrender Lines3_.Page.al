page 50729 "Imprest Surrender Lines3"
{
    AutoSplitKey = true;
    PageType = ListPart;
    ...
    begin
        ...
        if PaymentRec.FindFirst() then begin
            PaymentRec2.Reset();
            PaymentRec2.SetRange("No.", PaymentRec."Imprest Issue Doc. No");
            if PaymentRec2.FindFirst() then if PaymentRec2.Requisition = true then IsActivity := true;
        end;
    end;
}
