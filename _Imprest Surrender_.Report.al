report 50107 "Imprest Surrender"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ImprestSurrender.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = WHERE("Payment Type" = FILTER("Imprest Surrender" | "Service Charge Surrender"));
            ...
            column(PreparedBy; GetUserName(UserId))
            {
            }
            ...
            column(CheckedBy; GetUserName(Approver[1]))
            {
            }
            column(Datechecked; ApproverDate[1])
            {
            }
            column(CheckedBy_Signature; UserSetup.Signature)
            {
            }
            ...
            dataitem("Ext Payment Lines"; "Ext Payment Lines")
            {
                ...
                column(Actual_Spent__LCY_; "Actual Spent (LCY)")
                {
                }
            }
            ...
            begin
                //Payments.CalcFields("Actual Amount Spent");
            end;
        }
    }
    requestpage
