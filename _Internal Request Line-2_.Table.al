table 50174 "Internal Request Line-2"
{
    ...
    fields
    {
        ...
        field(15; Quantity; Decimal)
        {
            ...
            begin
                ...
                if "Procurement Plan Item" <> '' then begin
                    ...
                    if "Line Amount" > "Approved Budget Amount" then Error('Total amount %1 cannot be more than planed amount of %2', "Line Amount", "Approved Budget Amount");
                end;
                CalcFields("Quantity In Stock");
                if(Quantity > "Quantity In Stock") and not("Document Type" = "Document Type"::Purchase)then Error(Text055, FieldCaption(Quantity), FieldCaption("Quantity In Stock"));
                //Test Planned Qty
        ...
        field(1702; "Returns Deferral Start Date"; Date)
        {
            ...
            begin
            //GetPurchHeader;
            // eddie if DeferralHeader.Get(DeferralUtilities.GetPurchDeferralDocType, '', '', "Document Type", "Document No.", "Line No.") then
        ...
        field(5790; "Requested Receipt Date"; Date)
        {
            ...
            begin
                TestStatusOpen;
                if(CurrFieldNo <> 0) and ("Promised Receipt Date" <> 0D)then Error(Text023, FieldCaption("Requested Receipt Date"), FieldCaption("Promised Receipt Date"));
                if "Requested Receipt Date" <> xRec."Requested Receipt Date" then GetUpdateBasicDates;
            end;
        }
    ...
    local procedure GetCaptionClass(FieldNumber: Integer): Text[80]begin
        ...
        case FieldNumber of FieldNo("No."): begin
            // eddie if ApplicationAreaSetup.IsFoundationEnabled then
    ...
    //eddie  exit(DeferralUtilities.OpenLineScheduleEdit(
    //     "Deferral Code", DeferralUtilities.GetPurchDeferralDocType, '', '',
    //     "Document Type", "Document No.", "Line No.",
