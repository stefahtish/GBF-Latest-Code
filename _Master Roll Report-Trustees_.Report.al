report 50268 "Master Roll Report-Trustees"
{
    DefaultLayout = RDLC;
    RDLCLayout = './MasterRollReportTrustees.rdl';
    ApplicationArea = All;
        ...
        dataitem(Employee; Employee)
        {
            ...
            begin
                ...
                for i := 1 to NoOfEarnings do begin
                    ...
                    Assignmat.SetRange("Employee Type", Assignmat."Employee Type"::Trustee);
    ...
    begin
        ...
        EarnRec.SetRange("Employee Type Filter", EarnRec."Employee Type Filter"::Trustee);
        ...
        DedRec.SetRange("Employee Type Filter", DedRec."Employee Type Filter"::Trustee);
        if DedRec.Find('-') then
            repeat
