report 50504 "Modified Purchases Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Report 51521636 LPO Report.rdl';
    Caption = 'LPO';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(DeliveryDate; "Purchase Header"."Delivery Date")
            {
            }
            column(TenderQuotationno; "Purchase Header"."Tender/Quotation ref no")
            {
            }
            column(QuoteNo_; "Purchase Header"."Quote No.")
            {
            }
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        column(Specification2; Specifications)
                        {
                        }
                        trigger OnPreDataItem()
                        begin
