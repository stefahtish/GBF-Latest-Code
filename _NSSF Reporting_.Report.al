report 50229 "NSSF Reporting"
{
    DefaultLayout = RDLC;
    RDLCLayout = './NSSFReporting.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Assignment Matrix-X"; "Assignment Matrix-X")
        {
            ...
            column(ABS__Employer_Amount____ABS_Amount__ABS_EmpVoluntary_; Abs(EmployerAmt) + Abs(Amount) + Abs(EmpVoluntary))
            {
            }
            ...
            begin
                ...
                SumTotal := EmployeeTotal + EmployerTotal + EmpVoluntary;
