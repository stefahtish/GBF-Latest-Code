page 50326 "Negotiation Committee Creation"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(Tender), "Committee Type" = const(Negotiation));
    CardPageId = "Negotiation Commitee Card";
    ApplicationArea = All;
