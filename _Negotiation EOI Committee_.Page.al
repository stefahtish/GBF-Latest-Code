page 50343 "Negotiation EOI Committee"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(EOI), "Committee Type" = const(Negotiation));
    CardPageId = "Negotiation EOI Commitee Card";
    ApplicationArea = All;
