page 50337 "Negotiation RFP Committee"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(RFP), "Committee Type" = const(Negotiation));
    CardPageId = "Negotiation RFP Commitee Card";
    ApplicationArea = All;
