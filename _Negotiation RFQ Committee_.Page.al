page 50331 "Negotiation RFQ Committee"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(Quotation), "Committee Type" = const(Negotiation));
    CardPageId = "Negotiation RFQ Commitee Card";
    ApplicationArea = All;
