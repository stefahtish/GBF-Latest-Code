page 51438 "Open Contract Extensions"
{
    CardPageID = "Open Contract Extension";
    Caption = 'Open Contract Extension';
    Editable = false;
    PageType = List;
    InsertAllowed = false;
    SourceTable = "Project Header";
    SourceTableView = WHERE(Status = CONST("Open Extensions"), "Direct Contract" = const(false));
    ApplicationArea = All;
