report 50256 "P9A Report-Self Service"
{
    DefaultLayout = RDLC;
    RDLCLayout = './P9AReportSelfService.rdl';
    UseRequestPage = true;
    ApplicationArea = All;
            ...
            dataitem("Payroll PeriodX"; "Payroll PeriodX")
            {
                ...
                begin
                    ...
                    */
                    ...
                    Earn.SetFilter(Earn."Earning Type", '<>%1', Earn."Earning Type"::"Owner Occupier");
                    Earn.SetFilter(Earn."Earning Type", '<>%1', Earn."Earning Type"::"Insurance Relief");
                    Earn.SetFilter(Earn."Earning Type", '<>%1', Earn."Earning Type"::"Tax Relief");
                    if Earn.Find('-') then begin
                        AssMatrix.Reset;
                        AssMatrix.SetRange(AssMatrix.Type, AssMatrix.Type::Payment);
                        AssMatrix.SetRange(AssMatrix."Employee No", Employee."No.");
