report 50263 "PAYE Report - Primary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PAYEReportPrimary.rdl';
    Caption = 'PAYE Report';
    ApplicationArea = All;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("No.") where("Employment Type" = filter(trustee));
            RequestFilterFields = "Pay Period Filter", "No.", Status, "Secondary Employee", "Employment Type";
            ...
            begin
                Employee.CalcFields(Employee."Total Allowances", Employee."Total Deductions", "Loan Interest", "Cumm. PAYE");
                if Employee."Cumm. PAYE" = 0 then CurrReport.Skip;
                counter := counter + 1;
                ...
                for i := 1 to NoOfEarnings do begin
                    ...
                    if Assignmat.Find('-') then begin
                        ...
                        else if Earncode[i] = 'GROSS PAY' then Allowances[i] := Employee."Total Allowances";
                    end;
                end;
                ...
                for i := NoOfEarnings + 1 to NoOfEarnings + NoOfDeductions do begin
                    ...
                    if Assignmat.Find('-') then begin
                        ...
                        else if Earncode[i] = 'NET PAY' then Allowances[i] := Employee."Total Allowances" + Employee."Total Deductions" + Employee."Loan Interest";
                    end;
                end;
    ...
    begin
        ...
        DedRec.SetRange("PAYE Code", true);
        if DedRec.Find('-') then
            repeat
