report 50122 "Payment Voucher-Vendor"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PaymentVoucherVendor.rdlc';
    ApplicationArea = All;
    ...
    var
        ...
        Branch: Text;
        VendAddress: Text;
        ISOCaption: Label 'KUC/ADMIN/R/035';
        ISOCert: Text;
        InvoiceDate: Date;
    ...
    begin
        if PurchInvHeader.Get(DocNo) then exit(PurchInvHeader."Vendor Invoice Date");
    end;
}
