table 50381 "Payroll Period Casuals"
{
    fields
    {
        ...
        {
            CalcFormula = Sum("Assignment Matrix-X".Amount WHERE("Payroll Period"=FIELD("Starting Date"), Paye=CONST(true)));
            FieldClass = FlowField;
        }
        field(50003; "Basic Pay"; Decimal)
        {
            CalcFormula = Sum("Assignment Matrix-X".Amount WHERE("Payroll Period"=FIELD("Starting Date"), "Basic Salary Code"=CONST(true)));
            FieldClass = FlowField;
        }
