page 50773 "Pending Store Request"
{
    CardPageID = "Approved/Post Store Req Card";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    RefreshOnActivate = true;
    SourceTable = "Internal Request Header";
    SourceTableView = WHERE("Document Type" = CONST(Stock), Status = FILTER("Pending Approval"), Posted = CONST(false));
    ApplicationArea = All;
