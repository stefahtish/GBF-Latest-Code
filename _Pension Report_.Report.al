report 50238 "Pension Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PensionReport.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Employee No", Type, Code, "Payroll Period", "Reference No") ORDER(Ascending) WHERE(Type = CONST(Deduction), Code = CONST('D009'));
