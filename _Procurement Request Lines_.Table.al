table 50136 "Procurement Request Lines"
{
    fields
    {
        ...
        field(37; "FA Disposal No"; code[20])
        {
            ...
            CalcFormula = lookup("Procurement Request"."FA Disposal No." where("Requisition No"=field(No)));
        }
        field(39; "Process Type"; Option)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Procurement Request"."Process Type" where("Requisition No"=field(No)));
