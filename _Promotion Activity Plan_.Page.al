page 51044 "Promotion Activity Plan"
{
    PageType = Card;
    Caption = 'Promotion';
        ...
        area(content)
        {
            Group(General)
            {
                ...
                group(Location)
                {
                    ...
                    field("County Name2"; Rec."County Name")
                    {
                        ApplicationArea = All;
                    }
                    ...
                    field("Sub-County Name2"; Rec."Sub-County Name")
                    {
                        ApplicationArea = All;
                    }
                }
            ...
            {
                ApplicationArea = Basic, Suite;
                SubPageLink = "Document No." = FIELD(Code), Activity = const(Promotion);
            }
        }
    }
    actions
    {
        area(Processing)
        {
            ...
            action("Promotion Activity plan")
            {
                ...
                begin
                    ...
                    REPORT.RUN(Report::"Promotion Activity", TRUE, FALSE, Workplan);
                end;
            }
        }
    }
    ...
    begin
        Rec."Research type" := Rec."Research type"::Export;
    end;
