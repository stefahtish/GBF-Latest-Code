table 50173 "Prospective Tender Line"
{
    fields
    {
        ...
        field(28; Specification2; Blob)
        {
            Caption = 'Specification';
            DataClassification = ToBeClassified;
        }
        field(29; "Vendor No"; Code[50])
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Prospective Suppliers"."Vendor No" where("No."=field("Response No")));
        }
        field(30; "Tender Awarded"; Boolean)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Tender Evaluation Line".Awarded where("Quote No"=field("Tender No."), "Vendor No"=field("Response No")));
        }
        field(31; "RFQ Awarded"; Boolean)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Quote Evaluation".Awarded where("Quote No"=field("Tender No."), "Vendor No"=field("Vendor No")));
        }
        field(32; "EOI Awarded"; Boolean)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("EOI Evaluation Line".Awarded where("Quote No"=field("Tender No."), "Vendor No"=field("Vendor No")));
        }
        field(33; "RFP Awarded"; Boolean)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("RFP Evaluation Line".Awarded where("Quote No"=field("Tender No."), "Vendor No"=field("Vendor No")));
        }
        field(34; Suggested; Boolean)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(35; "Awarded"; Boolean)
        {
            Editable = false;
            DataClassification = ToBeClassified;
        }
        field(36; Comment; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(37; "Vendor Name"; Text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(38; "Passed Technical"; Boolean)
        {
            Editable = false;
            DataClassification = ToBeClassified;
        }
        field(39; "Average Mark"; Decimal)
        {
            Editable = false;
            DataClassification = ToBeClassified;
        }
        field(40; "Passed Preliminary"; Boolean)
        {
            Editable = false;
            DataClassification = ToBeClassified;
        }
        field(41; "Quantity Received"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
    }
    keys
    {
        key(Key1; "Response No", "Tender No.", "Line No")
        {
            Clustered = true;
        }
