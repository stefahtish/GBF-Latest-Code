report 50116 "Purchase - Invoice Custom"
{
    Caption = 'Purchase - Invoice Custom';
    ApplicationArea = All;
    UsageCategory = Administration;
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Report 51519013 - Purchase - Invoice Custom.rdl';
    ...
    dataset
    {
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            column(CompanyBankAccountNo2; CompanyInfo."Bank Account No.2")
            {
            }
            column(CompanyBankAccountNo3; CompanyInfo."Bank Account No.3")
            {
            }
            column(CompanyBankAccountName; CompanyInfo."Bank Account Name")
            {
            }
            column(CompanyBankName; CompanyInfo."Bank Name")
            {
            }
            column(CompanyBankBranchName; CompanyInfo."Bank Branch Name")
            {
            }
