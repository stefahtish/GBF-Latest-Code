page 50789 "Purchase Order- Released"
{
        ...
        area(processing)
        {
            group(Approval)
            {
                ...
                action(RejectLPO)
                {
                    ...
                    begin
                        if Confirm('Are you sure you want to cancel LPO No. %1', false, Rec."No.") = true then begin
                            ...
                            Message('LPO %1 cancelled successfully', Rec."No.");
                        end
                        else
                            exit;
                        Commit;
