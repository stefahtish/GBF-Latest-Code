page 50753 "Purchase Request Approved"
{
    ...
    SourceTableView = WHERE("Document Type" = CONST(Purchase), "Fully Ordered" = CONST(false), Status = FILTER(Fulfilled | Released), Archived = CONST(false));
    ApplicationArea = All;
