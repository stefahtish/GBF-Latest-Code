page 50315 "Quotation Committee Creation"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(Quotation), "Committee Type" = const(Opening));
    CardPageId = "Q Commitee Creation Card";
    ApplicationArea = All;
