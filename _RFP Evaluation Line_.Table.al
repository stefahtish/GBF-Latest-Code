table 50424 "RFP Evaluation Line"
{
    fields
    {
        ...
        {
            CalcFormula = Min("RFP Evaluation Line".Amount WHERE("Quote No"=FIELD("Quote No"), Type=FIELD(Type), "No."=FIELD("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(41; "Comments"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(42; "Supplier E-mail"; Text[100])
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Prospective Suppliers"."E-mail" where("No."=field("Vendor No")));
        }
        field(43; "Total Score"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(44; "Supplier Code"; Code[20])
        {
            FieldClass = FlowField;
            CalcFormula = lookup(Vendor."No." where(Name=field("Vendor Name")));
        }
    }
    keys
    {
