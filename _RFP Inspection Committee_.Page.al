page 50351 "RFP Inspection Committee"
{
    Caption = 'Inspection Committee';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(RFP), "Committee Type" = const(Inspection));
    CardPageId = "RFP Inspection Commitee Card";
    ApplicationArea = All;
