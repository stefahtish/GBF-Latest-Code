page 50350 "RFQ Inspection Commitee Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part("Committee Members Inspection"; "Committee Members Inspection")
            {
                Editable = DocEditable;
    ...
    actions
    {
        ...
        area(Reporting)
        {
            ...
            action("Evaluation Scores")
            {
                ...
                // begin
                //     CommiteeRec.Reset();
                //     CommiteeRec.SetFilter("Appointment No", "Appointment No");
                //     if CommiteeRec.FindFirst() then
                //         Report.Run(51519102, true, false, CommiteeRec);
                // end;
            }
        }
    }
