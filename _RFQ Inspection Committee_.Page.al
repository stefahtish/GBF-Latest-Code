page 50349 "RFQ Inspection Committee"
{
    Caption = 'Inspection Committee';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(Quotation), "Committee Type" = const(Inspection));
    CardPageId = "RFQ Inspection Commitee Card";
    ApplicationArea = All;
