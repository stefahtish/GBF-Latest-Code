report 50142 "Receivables-Payables-custom"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReceivablesPayables-cust.rdlc';
    ...
    var
        ...
        CustBalDueCaptionLbl: Label 'Cust. Balances Due (KES)';
        VendBalDueCaptionLbl: Label 'Vendor Balances Due (KES)';
        BalDateLCYCaptionLbl: Label 'Balance at Date (KES)';
        NetChangeLCYCaptionLbl: Label 'Net Change (KES)';
