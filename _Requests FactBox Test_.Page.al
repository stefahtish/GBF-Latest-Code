page 50736 "Requests FactBox Test"
{
    Caption = 'Drag and drop factbox';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            ...
            //     eddieusercontrol(DragDrop; DragDropAddIn)
            //     {
            //         ApplicationArea = All;
    ...
    begin
        //eddie  CurrPage.DragDrop.SendData(GetDataUriFromImage);
    end;
