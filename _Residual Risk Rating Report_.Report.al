report 50384 "Residual Risk Rating Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ResidualRiskRatingReport.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Risk Header"; "Risk Header")
        {
            ...
            column(Residual_Value_RiskHeader; "Risk Header"."Residual Value")
            {
            }
            ...
            column(Residual_RAG_Status_RiskHeader; "Risk Header"."Residual RAG Status")
            {
            }
