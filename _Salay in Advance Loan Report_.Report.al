report 50300 "Salay in Advance Loan Report"
{
    Caption = ' ';
    DefaultLayout = RDLC;
    RDLCLayout = './SalaryAdvanceLoanReport.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Payroll PeriodX"; "Payroll PeriodX")
        {
            ...
            dataitem(DeductionsX; DeductionsX)
            {
                ...
                DataItemTableView = SORTING(Code) where("Loan Type" = filter("Staff Advance"));
                ...
                dataitem("Assignment Matrix-X"; "Assignment Matrix-X")
                {
                    ...
                    begin
                        ...
                        //Get loan balances
                        LoanBalances.Reset;
                        LoanBalances.SetRange("Loan No", "Reference No");
                        LoanBalances.SetRange("Deduction Code", Code);
