report 50151 "Salesperson - Commission-cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalespersonCommission-Cust.rdlc';
    ...
    var
        ...
        SalesCommissionAmt_Control32CaptionLbl: Label 'Sales Commission (KES)';
        ProfitCommissionAmt_Control33CaptionLbl: Label 'Profit Commission (KES)';
        AdjProfit_Control39CaptionLbl: Label 'Adjusted Profit (KES)';
        AdjProfitCommissionAmt_Control45CaptionLbl: Label 'Adjusted Profit Commission (KES)';
