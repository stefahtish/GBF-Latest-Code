Page 50206 "Shareholders List"
{
    ...
    SourceTable = Vendor;
    SourceTableView = WHERE("Vendor Type"=const("Share holder"));
    UsageCategory = Lists;
    ...
    layout
    {
        ...
        area(factboxes)
        {
            ...
            // }
            //EDDIE part(Control14; "Social Listening FactBox")
            // {
            //     ApplicationArea = All;
            ...
            group(ActionGroupCDS)
            {
                ...
                action(CDSSynchronizeNow)
                {
                    ...
                    begin
                        ...
                        Vendor.Next;
                        if Vendor.Count = 1 then CRMIntegrationManagement.UpdateOneNow(Vendor.RecordId)
                        else
                        begin
        ...
        area(processing)
        {
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        if ApprovalsMgmt.CheckVendorApprovalsWorkflowEnabled(Rec)then ApprovalsMgmt.OnSendVendorForApproval(Rec);
                    end;
                }
            ...
            action(PayVendor)
            {
                ...
                PromotedIsBig = true;
                RunObject = Page "Vendor Ledger Entries";
                RunPageLink = "Vendor No."=FIELD("No."), "Remaining Amount"=FILTER(<0), "Applies-to ID"=FILTER(''), "Document Type"=FILTER(Invoice);
    ...
    // EDDIE trigger OnAfterGetCurrRecord()
    // var
    //     //EDDIESocialListeningMgt: Codeunit "Social Listening Management";
    //     CRMCouplingManagement: Codeunit "CRM Coupling Management";
    // begin
    ...
    //eddieCurrPage."Power BI Report FactBox".PAGE.InitFactBox(CurrPage.ObjectId(false), CurrPage.Caption, PowerBIVisible);
    end;
    // trigger OnOpenPage()
    // var
    //     //EDDIE SocialListeningSetup: Record "Social Listening Setup";
    //     CRMIntegrationManagement: Codeunit "CRM Integration Management";
    // begin
    ...
    begin
        Rec."Vendor Type":=Rec."Vendor Type"::"Share holder";
    end;
...
// EDDIElocal procedure SetVendorNoVisibilityOnFactBoxes()
// begin
