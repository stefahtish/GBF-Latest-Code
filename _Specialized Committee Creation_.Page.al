page 50329 "Specialized Committee Creation"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(Tender), "Committee Type" = const(Specialized));
    CardPageId = "Specialized Commitee Card";
    ApplicationArea = All;
