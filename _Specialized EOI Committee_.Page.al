page 50348 "Specialized EOI Committee"
{
    Caption = 'Committee Creation';
    PageType = List;
    SourceTable = "Tender Committees";
    SourceTableView = where("Procurement Method" = const(EOI), "Committee Type" = const(Specialized));
    CardPageId = "Specialized EOI Commitee Card";
    ApplicationArea = All;
