page 51390 "Supplier EvaluationSetupCard3"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("RFP Passmark"; Rec."RFP Passmark")
                {
                    ToolTip = 'Specifies the value of the RFP Passmark field.';
                    ApplicationArea = All;
                }
            }
            part(Lines; "Supplier Eval Setup Lines3")
            {
