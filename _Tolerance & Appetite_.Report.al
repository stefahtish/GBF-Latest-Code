report 50385 "Tolerance & Appetite"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ToleranceAppetite.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Risk Header"; "Risk Header")
        {
            ...
            column(Control_Risk__L___I_RiskHeader; "Risk Header"."Control Risk (L * I)")
            {
            }
