table 50451 "Treasury Office User Template"
{
    ...
    fields
    {
        ...
        field(3; "Receipt Journal Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat if(UserTemp.UserID <> Rec.UserID) and ("Receipt Journal Batch" <> '')then begin
        ...
        field(5; "Payment Journal Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat if(UserTemp.UserID <> Rec.UserID) and ("Payment Journal Batch" <> '')then begin
                            Error('Please note that another user has been assigned the same batch.');
                        end;
                    until UserTemp.Next = 0;
                end;
        ...
        field(7; "Petty Cash Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat if(UserTemp.UserID <> Rec.UserID) and ("Petty Cash Batch" <> '')then begin
                            Error('Please note that another user has been assigned the same batch.');
                        end;
                    until UserTemp.Next = 0;
                end;
        ...
        field(9; "Inter Bank Batch Name"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat if(UserTemp.UserID <> Rec.UserID) and ("Inter Bank Batch Name" <> '')then begin
                            Error('Please note that another user has been assigned the same batch.');
                        end;
                    until UserTemp.Next = 0;
                end;
        ...
        field(12; "Default Petty Cash Bank"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat if UserTemp.UserID <> Rec.UserID then begin
                            Error('Please note that another user has been assigned the same bank.');
                        end;
                    until UserTemp.Next = 0;
                end;
        ...
        field(31; "Allow Posting of Receipts"; Boolean)
        {
        }
        field(32; "Allow Bank Selection"; Boolean)
        {
        }
        field(33; "Enter Backdated Receipts"; Boolean)
        {
        }
    }
    keys
    ...
    var UserTemp: Record "Treasury Office User Template";
