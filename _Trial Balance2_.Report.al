report 50430 "Trial Balance2"
{
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(NetAmt_DebitTotal; NetAmt_DebitTotal)
                {
                }
                column(NetAmt_CreditTotal; NetAmt_CreditTotal)
                {
                }
            ...
            trigger OnAfterGetRecord()
            begin
                "G/L Account".SetFilter("Date Filter", PeriodText);
                ...
                if GlAccount.Find('-')then begin
                    repeat NetAmt_DebitTotal+=GlAccount."Net Change";
    ...
    NetAmt_DebitTotal: Decimal;
    NetAmt_CreditTotal: Decimal;
}
