report 50273 "Trustee Earnings"
{
    Caption = 'Earnings';
    DefaultLayout = RDLC;
    RDLCLayout = './TrusteeEarnings.rdl';
    ApplicationArea = All;

    dataset
    {
        dataitem("Payroll PeriodX"; "Payroll Period Trustees")
        {
            ...
            dataitem(EarningsX; EarningsX)
            {
                ...
                dataitem("Assignment Matrix-X"; "Assignment Matrix-X")
                {
                    ...
                    DataItemTableView = SORTING("Employee No", Type, Code, "Payroll Period", "Reference No") WHERE(Type = CONST(Payment), "Employee Type" = const(Trustee));
