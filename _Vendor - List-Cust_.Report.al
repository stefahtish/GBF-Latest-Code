report 50158 "Vendor - List-Cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VendorList-Cust.rdlc';
    Caption = 'Vendor List';
    UsageCategory = None;
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(Vendor__Balance__LCY__Caption; BalanceCaptionLCY)
            {
            }
            ...
            begin
                ...
                FormatAddr.FormatAddr(VendAddr, Name, "Name 2", '', Address, "Address 2", City, "Post Code", County, "Country/Region Code");
            end;
        }
    }
    requestpage
    ...
    var
        ...
        BalanceCaptionLCY: Label 'Balance (KES)';
}
