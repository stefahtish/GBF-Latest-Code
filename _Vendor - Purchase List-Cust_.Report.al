report 50160 "Vendor - Purchase List-Cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VendorPurchaseList-Cust.rdlc';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            begin
                ...
                if AmtPurchLCY < MinAmtLCY then CurrReport.Skip();
                if not HideAddr then FormatAddr.Vendor(VendorAddr, Vendor);
            end;
        }
    }
    requestpage
    ...
    var
        ...
        MinAmtLCYCaptLbl: Label 'Amounts (KES) greater than';
        AmtPurchLCYCaptLbl: Label 'Amount of Purchase (KES)';
        TotRptedAmtofPurchLCYCaptLbl: Label 'Total Reported Amount of Purchase (KES)';
