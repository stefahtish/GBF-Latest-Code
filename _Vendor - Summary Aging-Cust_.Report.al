report 50161 "Vendor - Summary Aging-Cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VendorSummaryAging-Cust.rdlc';
    ...
    begin
        ...
        for i := 3 to 5 do PeriodStartDate[i] := CalcDate(PeriodLength, PeriodStartDate[i - 1]);
    ...
    var
        ...
        All_amounts_are_in_LCYCaptionLbl: Label 'All amounts are in KES.';
        ...
        Total__LCY_CaptionLbl: Label 'Total (KES)';
