report 50155 "Vendor Register-Cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VendorRegister-Cust.rdlc';
    ...
    dataset
    {
        dataitem("G/L Register"; "G/L Register")
        {
            ...
            dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
            {
                ...
                begin
                    if not Vend.Get("Vendor No.") then Vend.Init();
    ...
    var
        ...
        VendDebitAmountLCYCaptionLbl: Label 'Debit (KES)';
        VendCreditAmountLCYCaptionLbl: Label 'Credit (KES)';
        VendAmountLCYCaptionLbl: Label 'Total (KES)';
        VendDebitAmountLCY_Control61CaptionLbl: Label 'Debit (KES)';
        VendCreditAmountLCY_Control64CaptionLbl: Label 'Credit (KES)';
        VendAmountLCY_Control67CaptionLbl: Label 'Total (KES)';
