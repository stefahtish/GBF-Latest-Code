report 50164 "Vendor/Item Purchases-cust"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VendorItemPurchases-Cust.rdlc';
            ...
            dataitem("Value Entry"; "Value Entry")
            {
                ...
                begin
                    ...
                    if not (ValueEntry.Next = 0) then begin
                        if ValueEntry."Item No." = "Item No." then CurrReport.Skip();
                        ResetItemTotal := true
                    end
                end;
    ...
    labels
    {
        ...
        PageLabel = 'Page';
        AllAmountsinLCYLabel = 'All amounts are in KES';
